...
const translations = {
  'zh-CN': {
    ...
    'contact.form.note': '提交后，系统会整理您的信息并生成文档下载，同时保留表单内容方便您修改。请将下载的文档内容发送到指定邮箱或微信。',
  ...
  'zh-TW': {
    ...
    'contact.form.submit': '在本地整理信息',
    'contact.form.note': '提交後，系統會整理您的信息並生成文檔下載，同時保留表單內容方便您修改。請將下載的文檔內容發送到指定郵箱或微信。',
  ...
  'en': {
    ...
    'contact.form.note': 'After submission, the system will organize your information and generate a document for download, while keeping the form content intact for easy editing. Please send the downloaded document to the specified email or WeChat.',
  ...
  'ja': {
    ...
    'contact.form.note': '送信後、システムは情報を整理してドキュメントをダウンロードし、フォームの内容はそのまま残して編集しやすくします。ダウンロードしたドキュメントを指定のメールアドレスまたはWeChatに送信してください。',
